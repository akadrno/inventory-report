...
## Inventory
- [All Resources](platform-360/inventory-all.png)
- [Apps](platform-360/inventory-apps.png)
- [Flows](platform-360/inventory-flows.png)
- [Agents](platform-360/inventory-agents.png)
- [Environments](platform-360/inventory-environments.png)
- [Environment Groups](platform-360/inventory-groups.png)
- [Users](platform-360/inventory-users.png)
...
- [Maker Analytics](platform-360/governance-maker-analytics.png)
- [Risk Assessments](platform-360/governance-risk-assessments.png)

## Usage
- [Overview](platform-360/usage-overview.png)
- [Apps](platform-360/usage-apps.png)
- [Flows](platform-360/usage-flows.png)
- [Agents](platform-360/usage-agents.png)
- [Heatmap](platform-360/usage-heatmap.png)

## Tagging
- [Resources](platform-360/tagging-resources.png)
- [Term Store](platform-360/tagging-term-store.png)
